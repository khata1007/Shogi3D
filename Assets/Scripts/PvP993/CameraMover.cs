...
namespace PvP993
{
    public class CameraMover : MonoBehaviour
    {
        ...
        private bool cameraMovable = true; //カメラ入力は有効かどうか
        ...
        void LateUpdate()
        {
            if(cameraMovable) CameraPosotionControl();
        }
        ...
        public void MainCamera2DSetting(Vector3 pos, Vector3 center2D)
        {
            mainCameraTransform.position = pos;
            mainCameraTransform.LookAt(center2D, Vector3.up);
        }

        public bool CameraMovable { get { return cameraMovable; } set { cameraMovable = value; } }

        public Vector3 MainCameraTransformPosition { set { mainCameraTransform.position = value; mainCameraTransform.LookAt(center, Vector3.up); } get { return this.mainCameraTransform.position; } }
